...
class BetaWarningState extends MusicBeatState {
	...
	public override function create() {
		...
		disclaimer.applyMarkup("The engine that this mod uses is still in a alpha state. That means *majority of it's features* are either *buggy* or *non finished*. If you find any bug, please report them to the Codename Engine GitHub.\n\nPress ENTER to continue.",
			[
